...
-(void)downloadFile
{
    ...
    ODURLSessionDownloadTask *task = [[[[self.client drive] items:_fileitem.id] contentRequest] downloadWithCompletion:^(NSURL *filePath, NSURLResponse *response, NSError *error){
